...
export default function LosAngelesPrenup() {
  const schema = [
    {
      "@context": "https://schema.org",
      "@type": "LegalService",
      "name": "Drafter - Prenuptial Agreements in Los Angeles, CA",
    ...
    },
    {
      ...
      "itemListElement": [
        ...
        { "@type": "ListItem", "position": 3, "name": "Los Angeles Prenups", "item": "/states/california/los-angeles" }
      ]
    }
  ];
  ...
  return (
    <>
      <SEOHead
        title="Los Angeles Prenuptial Agreements | California Community Property | Drafter"
        description="Create a California-compliant prenuptial agreement for Los Angeles couples. Private AI, 10 minutes, attorney-ready. Optimized for CA community property rules."
        schema={schema}
      />
        ...
        <main className="py-12 md:py-16">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
            ...
            <h1 className="text-4xl md:text-5xl font-bold tracking-tight mb-4">
              Prenuptial Agreements in Los Angeles, CA
            </h1>
            <p className="text-lg text-muted-foreground mb-8">
              California-compliant prenups tailored for Los Angeles couples. Private AI, community property aware, and attorney-ready in minutes.
            </p>
            ...
            <div className="grid gap-6 md:grid-cols-2 mb-10">
              <Card>
                ...
                <CardContent className="text-sm text-muted-foreground">
                  California law presumes a 50/50 split of marital property. A prenup lets you customize how assets, income, and businesses are treated.
                </CardContent>
              </Card>
              <Card>
                <CardHeader>
