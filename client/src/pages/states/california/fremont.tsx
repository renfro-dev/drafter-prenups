...
export default function FremontPrenup() {
  const schema = [
    {
      "@context": "https://schema.org",
      "@type": "LegalService",
      "name": "Drafter - Prenuptial Agreements in Fremont, CA",
      "url": "https://drafter.com/states/california/fremont",
      "areaServed": {
        "@type": "City",
        "name": "Fremont",
        "address": {
    ...
    },
    {
      ...
      "itemListElement": [
        ...
        { "@type": "ListItem", "position": 3, "name": "Fremont Prenups", "item": "/states/california/fremont" }
      ]
    }
  ];
  ...
  return (
    <>
      <SEOHead
        title="Fremont Prenuptial Agreements | California Community Property | Drafter"
        description="Create a California-compliant prenuptial agreement for Fremont couples. Private AI, 10 minutes, attorney-ready. Optimized for CA community property rules."
        schema={schema}
      />
        ...
        <main className="py-12 md:py-16">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
            ...
            <h1 className="text-4xl md:text-5xl font-bold tracking-tight mb-4">
              Prenuptial Agreements in Fremont, CA
            </h1>
            <p className="text-lg text-muted-foreground mb-8">
              California-compliant prenups tailored for Fremont couples. Private AI, community property aware, and attorney-ready in minutes.
            </p>
            ...
            <div className="grid gap-6 md:grid-cols-2 mb-10">
              <Card>
                ...
                <CardContent className="text-sm text-muted-foreground">
                  Address RSUs, options, and variable compensation common across the Bay Area region.
                </CardContent>
              </Card>
              <Card>
                <CardHeader>
