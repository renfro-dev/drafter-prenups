...
export default function SanJosePrenup() {
  const schema = [
    {
      "@context": "https://schema.org",
      "@type": "LegalService",
      "name": "Drafter - Prenuptial Agreements in San Jose, CA",
      "url": "https://drafter.com/states/california/san-jose",
      "areaServed": {
        "@type": "City",
        "name": "San Jose",
        "address": {
    ...
    },
    {
      ...
      "itemListElement": [
        ...
        { "@type": "ListItem", "position": 3, "name": "San Jose Prenups", "item": "/states/california/san-jose" }
      ]
    }
  ];
  ...
  return (
    <>
      <SEOHead
        title="San Jose Prenuptial Agreements | California Community Property | Drafter"
        description="Create a California-compliant prenuptial agreement for San Jose couples. Private AI, 10 minutes, attorney-ready. Optimized for CA community property rules."
        schema={schema}
      />
        ...
        <main className="py-12 md:py-16">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
            ...
            <h1 className="text-4xl md:text-5xl font-bold tracking-tight mb-4">
              Prenuptial Agreements in San Jose, CA
            </h1>
            <p className="text-lg text-muted-foreground mb-8">
              California-compliant prenups tailored for San Jose couples. Private AI, community property aware, and attorney-ready in minutes.
            </p>
            ...
            <div className="grid gap-6 md:grid-cols-2 mb-10">
              <Card>
                ...
                <CardContent className="text-sm text-muted-foreground">
                  Address RSUs, options, and variable compensation common in Silicon Valley. Define separate vs community treatment to avoid disputes later.
                </CardContent>
              </Card>
              <Card>
                <CardHeader>
