...
export default function IrvinePrenup() {
  const schema = [
    {
      "@context": "https://schema.org",
      "@type": "LegalService",
      "name": "Drafter - Prenuptial Agreements in Irvine, CA",
      "url": "https://drafter.com/states/california/irvine",
      "areaServed": {
        "@type": "City",
        "name": "Irvine",
        "address": {
    ...
    },
    {
      ...
      "itemListElement": [
        ...
        { "@type": "ListItem", "position": 3, "name": "Irvine Prenups", "item": "/states/california/irvine" }
      ]
    }
  ];
  ...
  return (
    <>
      <SEOHead
        title="Irvine Prenuptial Agreements | California Community Property | Drafter"
        description="Create a California-compliant prenuptial agreement for Irvine couples. Private AI, 10 minutes, attorney-ready. Optimized for CA community property rules."
        schema={schema}
      />
        ...
        <main className="py-12 md:py-16">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
            ...
            <h1 className="text-4xl md:text-5xl font-bold tracking-tight mb-4">
              Prenuptial Agreements in Irvine, CA
            </h1>
            <p className="text-lg text-muted-foreground mb-8">
              California-compliant prenups tailored for Irvine couples. Private AI, community property aware, and attorney-ready in minutes.
            </p>
