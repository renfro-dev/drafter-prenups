...
export default function AnaheimPrenup() {
  const schema = [
    {
      "@context": "https://schema.org",
      "@type": "LegalService",
      "name": "Drafter - Prenuptial Agreements in Anaheim, CA",
      "url": "https://drafter.com/states/california/anaheim",
      "areaServed": {
        "@type": "City",
        "name": "Anaheim",
        "address": {
    ...
    },
    {
      ...
      "itemListElement": [
        ...
        { "@type": "ListItem", "position": 3, "name": "Anaheim Prenups", "item": "/states/california/anaheim" }
      ]
    }
  ];
  ...
  return (
    <>
      <SEOHead
        title="Anaheim Prenuptial Agreements | California Community Property | Drafter"
        description="Create a California-compliant prenuptial agreement for Anaheim couples. Private AI, 10 minutes, attorney-ready. Optimized for CA community property rules."
        schema={schema}
      />
      <div className="min-h-screen bg-background">
        ...
        <main className="py-12 md:py-16">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
            ...
            <h1 className="text-4xl md:text-5xl font-bold tracking-tight mb-4">
              Prenuptial Agreements in Anaheim, CA
            </h1>
            <p className="text-lg text-muted-foreground mb-8">
              California-compliant prenups tailored for Anaheim couples. Private AI, community property aware, and attorney-ready in minutes.
            </p>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
          <NearbyCities
            cities={[
              { name: "Santa Ana", href: "/states/california/santa-ana" },
